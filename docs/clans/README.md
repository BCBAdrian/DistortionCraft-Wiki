...
Клан захватывает землю по чанкам, в зависимости от того, сколько единиц силы он имеет, из расчета 1 чанк на с1 единицу силы. На своей территории члены клана могут строить исключительно без вмешательства других членов (настраивается с помощью команды /f perms). Территория клана - это место, где вы можете построить свою базу, установить местоположение дома клана, создать варпы и многое другое.
